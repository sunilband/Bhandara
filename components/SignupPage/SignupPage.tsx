  ...
  return (
    <>
      ...
      <div className="z-10 h-screen w-screen relative flex sm:justify-end justify-center items-center px-3">
        ...
        {/* login box */}
        <div className="h-[620px] w-[400px] sm:mr-[120px] rounded-[40px] bg-[#FFFF]/70 p-[44px]">
          <div className="poppinsFont">
            <div className="flex justify-between p-0 m-0">
              ...
              <Link href="/login">
                <div className="w-[110px] flex justify-end items-end flex-col">
                  <p className="text-[13px] font-normal cursor-pointer w-full">
                    Have an account?
                  </p>
            ...
            <h2 className="text-[45px] font-[500] tracking-wide">Sign up</h2>
            ...
            <div className="w-full h-[55px] mt-8 relative flex justify-center items-center bg-[#E9F1FF] rounded-[9px] cursor-pointer">
              <div className="flex gap-4 cursor-pointer">
                ...
                />
                <p className="text-[#4285F4] ">Sign up with Google</p>
              </div>
            </div>
